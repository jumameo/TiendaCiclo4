...
<title>La Generica Header</title>
	...
	<div class="container-fluid overflow-hidden">
		<div class="row vh-100 overflow-auto">
			<div
				...
				<div
					...
					<a href="#"
						...
						<span class="fs-5">L<span class="d-none d-sm-inline">a Genérica</span></span>
					</a>
					<ul
						...
						<li><a href="usuario.jsp" class="nav-link px-sm-0 px-2">
								<i class="fs-5 bi-people"></i><span
								class="ms-1 d-none d-sm-inline">Usuarios</span>
						</a></li>
						<li><a href="Clientes.jsp" class="nav-link px-sm-0 px-2">
								<i class="fs-5 bi-person-check"></i><span
								class="ms-1 d-none d-sm-inline">Clientes</span>
						</a></li>
						<li><a href="proveedores.jsp" class="nav-link px-sm-0 px-2">
								<i class="fs-5 bi-building"></i><span
								class="ms-1 d-none d-sm-inline">Proveedores</span>
						</a></li>
						<li><a href="productos.jsp" class="nav-link px-sm-0 px-2">
								<i class="fs-5 bi-grid"></i><span
								class="ms-1 d-none d-sm-inline">Productos</span>
						</a></li>
						...
						<li><a href="reportes.jsp" class="nav-link px-sm-0 px-2">
								<i class="fs-5 bi-card-checklist"></i><span
			...
			<div class="col d-flex flex-column h-100">
				...
				<nav class="navbar navbar-dark bg-secondary justify-content-end"
					style="margin-left: calc(-1*var(--bs-gutter-x)* .5)!important;margin-right: calc(-1*var(--bs-gutter-x)* .5)!important;">
					<!-- Navbar content -->
					<div
						class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1"
						style="margin-right: calc(var(--bs-gutter-x)* .5)!important;">
						<a href="#"
							class="d-flex align-items-center text-white text-decoration-none dropdown-toggle"
							id="dropdownUser1" data-bs-toggle="dropdown"
							aria-expanded="false"> <img src="..."
							onerror="this.src='img/defaultavatar.jpg';this.onerror='';"
							width="28" height="28" class="rounded-circle"> <span
							class="d-none d-sm-inline mx-1">
								${sessionScope.usuario.nombre_usuario} </span>
						</a>
						<ul class="dropdown-menu dropdown-menu-dark text-small shadow"
							aria-labelledby="dropdownUser1">
							<li><a class="dropdown-item"
								href="usuario?tipo=cerrarSesion">Cerrar sesión</a></li>
						</ul>
					</div>
				</nav>